defmodule Core.Release do
  ...
  @start_apps [:core, :phoenix_ecto, :sqlite_ecto2, :ecto, :poolboy, :decimal, :db_connection, :connection, :phoenix_live_reload, :file_system,
  ...
  def seed do
    ...
    Logger.info "Starting Hécatéros"

    # Load the code for Core but don't start it
